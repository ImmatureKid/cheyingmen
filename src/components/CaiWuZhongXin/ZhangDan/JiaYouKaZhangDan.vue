        ...
        <header class="content_title">
            <ul class="title_box">
                <li class="title_box_left">
                    ...
                    <span class="name_title"> &nbsp;加油卡账单</span>
                </li>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr v-for="(list, index) in listsTable" :key="index">
                        ...
                        <td> {{list.phone}} </td>
                        <td> {{list.recharge_time}} </td>
                        <td> {{list.gas_card_name}} </td>
...
export default {
    ...
    methods: {
        init: function (curr) {
            ...
            // 搜索的 字段
            if (this_1.jia_name) aaa.card_name = this_1.jia_name
            ...
            // ajax-post
            var url = '/backStage/gasCardClose/select'
            post_ajax(url, aaa, function (json) {
                ...
                this_1.listsTable.forEach(item => {
                    item.recharge_time && (item.recharge_time = get_str_time(item.recharge_time))
                });
