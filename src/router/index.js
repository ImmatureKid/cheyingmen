...
// 账单
import JiaYouQuanZhangDan from '../components/CaiWuZhongXin/ZhangDan/JiaYouQuanZhangDan'
import JiaYouKaZhangDan from '../components/CaiWuZhongXin/ZhangDan/JiaYouKaZhangDan'
...
// 系统管理
import JiaYouZhanGuanLi from '@/components/XiTongGuanLi/ShangJiaGuanLi/JiaYouZhanGuanLi' // 加油站管理
...
export default new Router({
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/JiaYouZhanGuanLi',
        name: 'JiaYouZhanGuanLi',
        component: JiaYouZhanGuanLi
      },
      {
        path: '/JiaYouQuanZhangDan',
        name: 'JiaYouQuanZhangDan',
        component: JiaYouQuanZhangDan
      },
      {
        path: '/JiaYouKaZhangDan',
        name: 'JiaYouKaZhangDan',
        component: JiaYouKaZhangDan
      }
    ]
  }
  ]
